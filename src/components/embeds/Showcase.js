    ...
    <div>
      ...
      <Wrapper>
        <EmbedPage>
          ...
          <hr />
          <p>
            Тук ще видите различни варианти да вградите ТиБроиш във Вашия сайт!
          </p>
          ...
          ></iframe>
          <EmbedCodeDisplay
            code={`<iframe width="600" height="560" style="border: none;" loading="lazy" allowfullscreen src="https://tibroish.bg${publicURL}/embed/violations"></iframe>`}
          />
          ...
          ></iframe>
          <EmbedCodeDisplay
            code={`<iframe width="600" height="560" style="border: none;" loading="lazy" allowfullscreen src="https://tibroish.bg${publicURL}/embed/mini-results"></iframe>`}
          />
          ...
          ></iframe>
          <EmbedCodeDisplay
            code={`<iframe width="600" height="560" style="border: none;" loading="lazy" allowfullscreen src="https://tibroish.bg${publicURL}/embed/mini-results?mapOnly=true"></iframe>`}
          />
          ...
          ></iframe>
          <EmbedCodeDisplay
            code={`<iframe width="600" height="500" style="border: none;" loading="lazy" allowfullscreen src="https://tibroish.bg${publicURL}/embed/mini-results?resultsOnly=true"></iframe>`}
          />
          ...
          <select onClick={dropdownClicked}>
            {regions.map((region, idx) => (
              <option
                key={idx}
                selected={region.num === selectedRegion}
                value={region.num}
              >
                {region.name}
              </option>
          ...
          ></iframe>
          <EmbedCodeDisplay
            code={`<iframe width="600" height="500" style="border: none;" loading="lazy" allowfullscreen src="https://tibroish.bg${publicURL}/embed/mini-results/${selectedRegion}"></iframe>`}
          />
        </EmbedPage>
      </Wrapper>
      <Footer />
