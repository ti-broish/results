...
export const generateTooltipSingleParty = (singleParty, region, tooltipData) => {
    if(!singleParty) {
        return(`
            <div>
                <h2 style="margin: 5px;">${region.name}</h2>
        ...
        const partyResult = tooltipData.displayParties.find(party => party.number === singleParty);
        return(`
            <div>
                <h2 style="margin: 5px;">${region.name}</h2>
                <hr style="border-color: #aaa; border-top: none;"/>
                ...
                <tbody>
                    <tr>
                        <td>Партия</td>
                        <td style="color: #${partyResult.color}; padding-left: 20px;">${partyResult.displayName}</td>
                    </tr>
                    <tr>
                        <td>Гласове</td>
                        <td style="color: #${partyResult.color}; text-align: right; padding-left: 20px;">
                        ${
                    ...
                    <tr>
                        ...
                        ${
                            partyResult.validVotes?
                                `${formatPercentage(partyResult.validVotes / region.stats.validVotes)}%` :
                                `Няма данни`
                        }
                        </td>
                    </tr>
